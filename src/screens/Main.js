          ...
          <View key={i} style={styles.contentBox}>
            <View style={styles.row}>
              <View style={{marginRight: widthPercentage(10)}}>
                ...
                r.members.length === 2 ? (
                  <View style={{width: widthPercentage(56), height: widthPercentage(56), flex: 1, justifyContent: 'space-between'}}>
                    <Image
                      source={require('../assets/images/profile3.png')}
                      style={[styles.profileImg2, {
                        marginBottom: widthPercentage(-8), marginRight: widthPercentage(-8)}]}
                    />
                    <Image
                      source={require('../assets/images/profile4.png')}
                      style={[styles.profileImg2, {justifyContent: 'flex-end', marginTop: widthPercentage(-8), marginLeft: widthPercentage(19)}]}
                    />
                </View>
                  )
                :
              ...
              <View style={styles.spaceB}>
                <View>
                  ...
                  <Text style={styles.descript}>
                    {r.members[0]}님{r.members.length !== 1 && " 외 " + (r.members.length - 1) + "명"}과의 대화
                  </Text>
                  <Text style={styles.descript}>
